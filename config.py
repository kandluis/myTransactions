...
class Config:
    ...
    MISCLASSIFIED_CARD_PURCHASE_ACCOUNTS: List[str]
    SKIPPED_ACCOUNTS: List[str]
    HISTORICAL_ACCOUNT_ALIASES: Dict[str, str]
    IGNORED_MERCHANTS: List[str]
    IGNORED_MERCHANT_PREFIXES: List[str]
    ...
    EXACT_MERCHANT_TO_CATEGORY_MAP: Dict[str, str]
